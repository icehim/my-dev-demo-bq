...
!(function (t, i) {
  ...
  return (function (t) {
    ...
    function (t, i, e) {
      ...
      const a = n.a.Class.extend({
          ...
          _getCalculateTrackPointByTime: function (t) {
            ...
            let d = f / (l - c),
              ...
              y =
                s.x >= e.x
                  ? (180 * (0.5 * Math.PI - Math.asin(k))) / Math.PI
                  : (180 * (1.5 * Math.PI + Math.asin(k))) / Math.PI;
            return (
              i
                ? void 0 === i.dir && (i.dir = y)
                : (i = { lng: g, lat: x, dir: y, isOrigin: !1, time: t }),
              i
            );
          },
          getTrackPointsBeforeTime: function (t) {
            let i = [];
            for (let e = 0, s = this._trackPoints.length; e < s; e++)
              this._trackPoints[e].time < t && i.push(this._trackPoints[e]);
            ...
            for (let i = 0; i < t; i++)
              for (let e = 0; e < t - 1 - i; e++)
                if (this._trackPoints[e].time > this._trackPoints[e + 1].time) {
                  ...
                  ((this._trackPoints[e + 1] = this._trackPoints[e]),
                    (this._trackPoints[e] = t));
                }
          },
          _updatetimeTick: function () {
            this._timeTick = {};
            for (let t = 0, i = this._trackPoints.length; t < i; t++)
              this._timeTick[this._trackPoints[t].time] = t;
          }
        }),
        o = n.a.Class.extend({
          ...
          _updateTime: function () {
            ...
            for (let t = 0, i = this._tracks.length; t < i; t++) {
              ...
              (i < this._minTime && (this._minTime = i),
                e > this._maxTime && (this._maxTime = e));
            }
          }
        }),
        h = n.a.Class.extend({
          includes: n.a.Evented.prototype,
          options: { speed: 12, maxSpeed: 65 },
          initialize: function (t, i) {
            (n.a.setOptions(this, i),
          ...
          start: function () {
            this._intervalID ||
              (this._intervalID = n.a.Util.requestAnimFrame(this._tick, this));
          },
          stop: function () {
            this._intervalID &&
              (n.a.Util.cancelAnimFrame(this._intervalID),
              (this._intervalID = null),
              (this._lastFpsUpdateTime = 0));
          },
          rePlaying: function () {
          ...
          _caculatefpsTime: function (t) {
            ...
            return (
              (i =
                0 === this._lastFpsUpdateTime
                  ? 0
                  : t - this._lastFpsUpdateTime),
              (this._lastFpsUpdateTime = t),
              (i /= 1e3)
            );
          },
          _tick: function () {
            ...
            ((this._curTime += e),
              this._curTime >= this._endTime &&
                ((this._curTime = this._endTime), (i = !0)),
              this._trackController.drawTracksByTime(this._curTime),
              this.fire('tick', { time: this._curTime }),
              i ||
                (this._intervalID = n.a.Util.requestAnimFrame(
                  this._tick,
                  this
                )));
          }
        ...
        c = n.a.Renderer.extend({
          ...
          onAdd: function (t) {
            ((this._container = n.a.DomUtil.create(
              'canvas',
          ...
          _update: function () {
            if (!this._map._animatingZoom || !this._bounds) {
              ...
              (n.a.DomUtil.setPosition(i, t.min),
                (i.width = s * e.x),
                (i.height = s * e.y),
                (i.style.width = e.x + 'px'),
                (i.style.height = e.y + 'px'),
                n.a.Browser.retina && this._ctx.scale(2, 2),
        ...
        l = n.a.Class.extend({
          ...
          toolTipOptions: { offset: [0, 0], direction: 'top', permanent: !1 },
          initialize: function (t, i) {
            if (
              (n.a.extend(this.trackPointOptions, i.trackPointOptions),
              ...
              (this._bufferTracks = []),
              this.trackPointOptions.useCanvas ||
                (this._trackPointFeatureGroup = n.a.featureGroup([]).addTo(t)),
          ...
          remove: function () {
            ((this._bufferTracks = []),
              ...
              this._trackLayer && this._map.removeLayer(this._trackLayer),
          ...
          _onmousemoveEvt: function (t) {
            ...
            (this._tooltip &&
              this._map.hasLayer(this._tooltip) &&
          ...
          _drawTrack: function (t) {
            ...
            let i = t[t.length - 1];
            (this.targetOptions.useImg && this._targetImg
              ? this._drawShipImage(i)
              : this._drawShipCanvas(i),
              this.targetOptions.showText &&
                this._drawtxt(`航向：${parseInt(i.dir)}度`, i),
              this._showTrackPoint &&
                (this.trackPointOptions.useCanvas
                  ? this._drawTrackPointsCanvas(t)
                  : this._drawTrackPointsSvg(t)));
          },
          _drawTrackLine: function (t) {
            ...
            (this._ctx.save(),
              this._ctx.beginPath(),
              this._ctx.moveTo(e.x, e.y));
            for (let i = 1, e = t.length; i < e; i++) {
              let e = this._getLayerPoint(t[i]);
              this._ctx.lineTo(e.x, e.y);
            }
            ((this._ctx.globalAlpha = i.opacity),
              i.stroke &&
                ((this._ctx.strokeStyle = i.color),
                (this._ctx.lineWidth = i.weight),
                this._ctx.stroke()),
              i.fill && ((this._ctx.fillStyle = i.fillColor), this._ctx.fill()),
              this._ctx.restore());
          },
            ...
            for (let e = 0, s = t.length; e < s; e++)
              if (t[e].isOrigin) {
                ...
                (this._ctx.beginPath(),
                  ...
                  (this._ctx.globalAlpha = i.opacity),
                  i.stroke &&
                    ((this._ctx.strokeStyle = i.color), this._ctx.stroke()),
                  i.fill &&
                    ((this._ctx.fillStyle = i.fillColor), this._ctx.fill()));
              }
            this._ctx.restore();
          },
          _drawTrackPointsSvg: function (t) {
            for (let i = 0, e = t.length; i < e; i++)
              if (t[i].isOrigin) {
                ...
                (s.bindTooltip(this._getTooltipText(t[i]), this.toolTipOptions),
        ...
        _ = n.a.Class.extend({
          ...
          initialize: function (t, i, e = {}) {
            ...
            ((this.tracks = this._initTracks(t)),
              (this.draw = new l(i, s)),
              (this.trackController = new o(this.tracks, this.draw)),
      ...
      ((n.a.TrackPlayBack = _),
        (n.a.trackplayback = function (t, i, e) {
          return new _(t, i, e);
        }));
    }
  ]);
